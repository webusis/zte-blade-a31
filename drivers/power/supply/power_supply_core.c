...
static void power_supply_changed_work(struct work_struct *work)
{
	...
	dev_info(&psy->dev, "%s [line=%d] ->: psy->changed=%d\n", __func__, __LINE__, psy->changed);
...
void power_supply_changed(struct power_supply *psy)
{
	...
	dev_info(&psy->dev, "%s [line=%d] ->: psy->desc->name=%s\n"
		 , __func__, __LINE__, psy->desc->name);
